        ...
        <section className="exp-section">
            ...
            <div className="container">
                ...
                <div className="education">
                    ...
                    <div className="edu-card">
                        <p className="card-text1">
                            <SlCalender className='icon' /> December 2023 - Present
                        </p>
                        <h3 className="card-text2">Smart india hackathon Winner 2023</h3>
                        <p className="card-text3">Working on Projects For Ministry OF Law</p>
                        <p className="card-text4">
                            Vaultx
                        </p>
                    </div>
                    ...
                    <div className="edu-card">
                        ...
                        <h3 className="card-text2">IDE Bootcamp </h3>
                        <p className="card-text3">Learned the Business Model and Innovation & Design</p>
                        <p className="card-text4">
